...
export default {
  ...
  methods: {
    ...
    list(page) {
      let _this = this;
      Loading.show();
      _this.$ajax.post(process.env.VUE_APP_SERVER + "/business/admin/user/list",
          {
            page: page,
    ...
    save() {
      ...
      _this.$ajax.post(process.env.VUE_APP_SERVER + "/business/admin/user/save",
    ...
    del(id) {
      ...
      Confirm.show("删除用户后不可恢复!",function () {
        Loading.show();
        _this.$ajax.post(process.env.VUE_APP_SERVER + "/business/admin/user/delete/" + id).then((response) => {
